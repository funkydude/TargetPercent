...
addon.boss5 = CreateFrame("Frame", "Boss5Percent", Boss5TargetFrameHealthBar)
addon.boss5:SetPoint("LEFT", Boss5TargetFrameHealthBar, "LEFT", -51, 0)
addon.boss5:SetWidth(50)
addon.boss5:SetHeight(20)
addon.boss5:EnableMouse(true)
addon.boss5:RegisterForDrag("LeftButton")
addon.boss5:SetClampedToScreen(true)
addon.boss5:SetMovable(true)
addon.boss5:SetScript("OnDragStart", startDrag)
addon.boss5:SetScript("OnDragStop", stopDrag)
addon.boss5:SetScript("OnEvent", healthUpdate)
addon.boss5:SetScript("OnShow", healthUpdate)
addon.boss5.unit = "boss5"
addon.boss5:RegisterEvent("INSTANCE_ENCOUNTER_ENGAGE_UNIT")
addon.boss5:RegisterUnitEvent("UNIT_HEALTH_FREQUENT", "boss5")
addon.boss5 = addon.boss5:CreateFontString("Boss5PercentText", "OVERLAY")
addon.boss5:SetAllPoints("Boss5Percent")
addon.boss5:SetFontObject(TextStatusBarText)
addon.boss5:SetJustifyH("RIGHT")
