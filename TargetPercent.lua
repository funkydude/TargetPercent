...
b1_hpFrame:EnableMouse(true)
b1_hpFrame:RegisterForDrag("LeftButton")
b1_hpFrame:SetClampedToScreen(true)
b1_hpFrame:SetMovable(true)
b1_hpFrame:SetScript("OnDragStart", startDrag)
b1_hpFrame:SetScript("OnDragStop", stopDrag)
...
b2_hpFrame:EnableMouse(true)
b2_hpFrame:RegisterForDrag("LeftButton")
b2_hpFrame:SetClampedToScreen(true)
b2_hpFrame:SetMovable(true)
b2_hpFrame:SetScript("OnDragStart", startDrag)
b2_hpFrame:SetScript("OnDragStop", stopDrag)
...
b3_hpFrame:EnableMouse(true)
b3_hpFrame:RegisterForDrag("LeftButton")
b3_hpFrame:SetClampedToScreen(true)
b3_hpFrame:SetMovable(true)
b3_hpFrame:SetScript("OnDragStart", startDrag)
b3_hpFrame:SetScript("OnDragStop", stopDrag)
...
b4_hpFrame:EnableMouse(true)
b4_hpFrame:RegisterForDrag("LeftButton")
b4_hpFrame:SetClampedToScreen(true)
b4_hpFrame:SetMovable(true)
b4_hpFrame:SetScript("OnDragStart", startDrag)
b4_hpFrame:SetScript("OnDragStop", stopDrag)
